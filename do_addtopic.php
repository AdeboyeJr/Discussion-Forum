...
$add_topic_sql = "INSERT INTO forum_topics (topic_title, topic_create_time, topic_owner) VALUES ('".$clean_topic_title. "'
...
<body>
    ...
    <h2><a href="topiclist.php">Go to topic list</a></h2>
</body>
</html>